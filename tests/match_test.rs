...
const TEST_DATA: &[TestData] = &[
    ...
    // td!(r#"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"#, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", &[("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", 0, 35)]),
    // td!(r#"ab"#, "ab", &[("ab", 0, 2)]),
    // td!(r#"b"#, "ab", &[("b", 1, 2)]),
    // td!(r#"bc"#, "abc", &[("bc", 1, 3)]),
    ...
    // td!(r#"\17"#, "\017", &[("\", 0, 1)]),
    // td!(r#"\x1f"#, "\x1f", &[("\", 0, 1)]),
    // td!(r#"a(?#....\\JJJJ)b"#, "ab", &[("ab", 0, 2)]),
    // td!(r#"(?x)  G (o O(?-x)oO) g L"#, "GoOoOgLe", &[("GoOoOgL", 0, 7)]),
    // td!(r#"."#, "a", &[("a", 0, 1)]),
    // td!(r#".."#, "ab", &[("ab", 0, 2)]),
    // td!(r#"\w"#, "e", &[("e", 0, 1)]),
    // td!(r#"\s"#, " ", &[(" ", 0, 1)]),
    ...
    // td!(r#"[[:\[:]]*"#, ":[", &[(":[", 0, 2)]),
    // td!(r#"[[:\]]]*"#, ":]", &[(":]", 0, 2)]),
    // td!(r#"[\044-\047]"#, "\046", &[("\", 0, 1)]),
    // td!(r#"[\x5a-\x5c]"#, "\x5b", &[("\", 0, 1)]),
    // td!(r#"[\x6A-\x6D]"#, "\x6c", &[("\", 0, 1)]),
    // td!(r#"[\[]"#, "[", &[("[", 0, 1)]),
    // td!(r#"[\]]"#, "]", &[("]", 0, 1)]),
    // td!(r#"[&]"#, "&", &[("&", 0, 1)]),
    // td!(r#"[[ab]]"#, "b", &[("b", 0, 1)]),
    ...
    // td!(r#"^a$"#, "a", &[("a", 0, 1)]),
    // td!(r#"^\w$"#, "a", &[("a", 0, 1)]),
    // td!(r#"^\wab$"#, "zab", &[("zab", 0, 3)]),
    // td!(r#"^\wabcdef$"#, "zabcdef", &[("zabcdef", 0, 7)]),
    // td!(r#"^\w...def$"#, "zabcdef", &[("zabcdef", 0, 7)]),
    // td!(r#"\w\w\s\Waaa\d"#, "aa  aaa4", &[("aa  aaa4", 0, 8)]),
    // td!(r#"\A\Z"#, "", &[]),
    // td!(r#"\Axyz"#, "xyz", &[("xyz", 0, 3)]),
